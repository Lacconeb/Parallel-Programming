...
int main( int argc, char *argv[ ] )
{
	...
	for( int t = 0; t < NUMTRIES; t++ )
    {
		...
		for( int i = 0; i < NUMNODES*NUMNODES; i++ )
		{
			...
			{
				volume += Height(iu,iv) * (fullTileArea/4.);
			}
		...
		avgPerformance += megaHeightsPerSecond;
    ...
    printf("Peak performance = %lf MegaHeights Per Second\n", maxPerformance);
    printf("Average performance = %lf MegaHeights Per Second\n", avgPerformance/ (double)NUMTRIES);
